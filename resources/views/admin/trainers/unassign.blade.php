                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title mb-0">Unassign Trainer</h4>
                        </div>
                        <div class="card-body">
                            @if($errors)
                                ...
                                @endforeach
                            @endif
                            <form method="POST" action="{{ route('admin.trainer.unassign.save') }}">
                                @csrf
                                    ...
                                    <div class="col-md-10">
                                        <select name="client" class="form-control form-select">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->client->id }}">{{ $user->client->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-auto float-end ms-auto">
                                    <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#add_trainer"><i
                                            class="fa-solid fa-trash"></i> Unassign</button>
                                </div>
                                {{-- <div class="input-block mb-3 row">
