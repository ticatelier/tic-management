        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Get Service Notes</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active">Get Service Notes</li>
                        </ul>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @if($errors)
                                ...
                                @endforeach
                            @endif
                            <form method="GET" action="{{ route('admin.analytics.servicenote.list') }}">
                                @csrf
                                ...
                                <div class="col-auto float-end ms-auto">
                                    <button type="submit" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#add_trainer"> View Service Notes</button>
                                </div>
                                {{-- <div class="input-block mb-3 row">
